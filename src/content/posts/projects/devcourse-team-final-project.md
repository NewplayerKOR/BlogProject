---
title: "[프로그래머스 데브코스 최종 프로젝트] - 시니어를 위한 AI 기반 디지털 교육 플랫폼 '디딤돌'"
date: "2025-11-21"
category: "프로젝트"
...
<details>
<summary style="cursor: pointer; font-weight: 600; color: #2563eb; padding: 8px 0; user-select: none;">📋 카테고리별 자료 검색</summary>
